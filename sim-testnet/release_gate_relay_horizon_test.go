...
func TestProducerGateStateSelectionFundedRelayRetainsAuthenticatedOwners(t *testing.T) {
	...
	for _, edge := range []struct {
		...
		{path: "evidence_relay_runtime.go", caller: "advance", callees: []string{"checkHorizonBlock", "readClosedPublication", "admit", "admitEvidenceRelayAction"}},
		{path: "evidence_relay_audit.go", caller: "advanceDepositAudits", callees: []string{"checkHorizonBlock", "readAuditPublication", "admit", "admitEvidenceRelayAction"}},
		{path: "evidence_relay_horizon_runtime.go", caller: "prepareHorizon", callees: []string{"readHorizonNative", "requireRemaining", "readAdmittedHorizon", "DiscoverValidatorEvidencePublicationV2Manifests", "DiscoverValidatorEvidenceDepositAuditV2Manifests", "readClosedPublication", "readAuditPublication"}},
		...
		{path: "evidence_relay_horizon_runtime.go", caller: "checkRemaining", callees: []string{"FinalizedBlockContext", "readHorizonNative", "requireRemaining"}},
